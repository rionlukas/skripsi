...
@section('content')
    ...
    <form action="{{ route('testing_post_order') }}" method="post">
      @csrf
                ...
                <div class="induk">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="mb-3">
                                <label for="inputJenisKain" class="form-label">Jenis Kain</label>
                                <input type="text" class="form-control inputJenisKain" id="inputJenisKain" name="JenisKain[]">
                            </div>
                        </div>
                        ...
                        <div class="col-md">
                            <div class="mb-3">
                                <label for="inputHarga" class="form-label">Harga</label>
                                <input type="number" class="form-control inputHarga id="inputHarga" name="Harga[]">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="mb-3">
                                <label for="inputTotalHarga" class="form-label">Total Harga</label>
                                <input type="number" class="form-control inputTotalHarga" id="inputTotalHarga" name="TotalHarga[]">
                            </div>
                        </div>
